        ...
        return (
            <>
                <Text align="justify" c="#fff">
                    At XYZ Company, we want to ensure your satisfaction with every purchase.
                    If for any reason you are not satisfied with your purchase, you may
                    return it within 30 days of the purchase date for a full refund or
                    exchange.
                </Text>

                <Text align="justify" c="#fff" mt={10}>
                    To initiate a return, please check our contact information page at <a href="/contact-information">contact</a>.
                </Text>
