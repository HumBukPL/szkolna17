...
import { comments3 } from "@/comments";
...
const ProductPage = () => {
  ...
  useEffect(() => {
    ...
    if (analytics) {
      logEvent(analytics, "page_view", { title: "Product Page 1" });
    }
  }, []);

  const product = {
    name: "Porshe 911 GT2 RS",
    year: "2018",
    price: "$700,000",
    imageSrc: "/Porshe1.png",
    mockData: [
    ...
    <>
      ...
      >
        ...
        <Flex justify="space-around" align="center" direction="row">
          ...
          >
            {/* header with text SPecifications */}
            <Text
              sx={{
                fontSize: 20,
                fontWeight: 700,
